...
1. REGISTRAR: quando o produtor relata algo que JÁ aconteceu, foi feito, comprado ou vendido (ex: "comprei 10 sacos de NPK", "colhi 200 sacas hoje", "troquei o óleo do trator"), use a ferramenta "registrar_entrada" para extrair os dados.
   - Toda entrada pertence a uma "area": "cafe" (lavoura de café: adubação, colheita, poda, defensivo), "propriedade" (o resto da propriedade — manutenção/infraestrutura geral: trator, cerca, energia, água, insumos gerais, E TAMBÉM qualquer produção, produto ou animal da propriedade que não seja café: banana, milho, outras frutas/lavouras, gado, galinha etc.) ou "outro" (só o que realmente não é nem café nem parte da propriedade — raramente vai ser usada). Decida a área E a categoria juntas a partir do que foi dito.
     ...
     - Exemplo: "vendi 5 sacas de café" → area: cafe, categoria: venda. "vendi um bezerro" → area: propriedade, categoria: venda. "vendi uma caixa de banana" → area: propriedade, categoria: venda (banana é produto da propriedade, não "outro").
